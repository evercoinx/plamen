...
Preview remaining phases:
  python ~/.claude/scripts/plamen_driver.py --dry-run "{PROJECT_PATH}/.scratchpad/config.json"

Clean restart:
  python ~/.claude/scripts/plamen_driver.py --fresh "{PROJECT_PATH}/.scratchpad/config.json"
```
